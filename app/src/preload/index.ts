...
const api: AlphaNexusApi = {
  ...
  workbench: {
    ...
    saveReviewCase: (input: SaveReviewCaseInput) => ipcRenderer.invoke('workbench:save-review-case', input),
    getReviewCase: (input: GetReviewCaseInput) => ipcRenderer.invoke('workbench:get-review-case', input),
    listReviewCases: (input?: ListReviewCasesInput) => ipcRenderer.invoke('workbench:list-review-cases', input),
