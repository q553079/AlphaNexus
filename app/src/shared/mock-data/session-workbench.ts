...
export const createMockWorkbenchDataset = (): MockDataset => {
  ...
  const screenshot: ScreenshotRecord = {
    ...
    raw_file_path: 'mock/chart-nq-opening-drive.svg',
    raw_asset_url: buildPlaceholderAssetUrl(),
    annotated_file_path: null,
    annotated_asset_url: null,
    annotations_json_path: null,
  ...
  const manageScreenshot: ScreenshotRecord = {
    ...
    asset_url: buildPlaceholderAssetUrl(),
    raw_file_path: 'mock/chart-nq-manage.svg',
    raw_asset_url: buildPlaceholderAssetUrl(),
    annotated_file_path: null,
    annotated_asset_url: null,
    annotations_json_path: null,
  ...
  const exitScreenshot: ScreenshotRecord = {
    ...
    asset_url: buildPlaceholderAssetUrl(),
    raw_file_path: 'mock/chart-nq-exit.svg',
    raw_asset_url: buildPlaceholderAssetUrl(),
    annotated_file_path: null,
    annotated_asset_url: null,
    annotations_json_path: null,
  ...
  const aiRun: AiRunRecord = {
    ...
    prompt_preview: '模拟 prompt preview',
    raw_response_text: '{"summary_short":"模拟 AI 输出"}',
    structured_response_json: '{"bias":"bullish"}',
