...
## Workflow
1. Scan `app/src/main`, `app/src/preload`, `app/src/renderer`, `app/src/shared`, and `tests/`.
...
- prevention rules
- suggested test and CI guardrails
...
- Ignore generated or vendored directories such as `node_modules/` and `out/`.
